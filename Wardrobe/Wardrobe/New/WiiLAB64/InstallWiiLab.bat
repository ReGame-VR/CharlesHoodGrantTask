...
C:\windows\Microsoft.NET\Framework64\v4.0.30319\regasm C:\\"Program Files"\WiiLAB\WiiLAB\WiiLAB.dll /unregister
echo **** Register WiiLab.dll   ****
C:\windows\Microsoft.NET\Framework64\v4.0.30319\regasm C:\\"Program Files"\WiiLAB\WiiLAB\WiiLAB.dll /tlb:WiiLAB.tlb /codebase
